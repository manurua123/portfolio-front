...
export class ExperienceComponent implements OnInit {
  experiences: Array<Experience> = [
    ...
    { cod: 3,
      ...
      begin: moment("2021/02/01", 'YYYY-MM-DD').toDate(),
      end: moment("2021/04/01", 'YYYY-MM-DD').toDate(),
    },
    ...
    { cod: 4,
      ...
      companyLink: "https://www.info.unlp.edu.ar/tutorias/",
      begin: moment("2020/03/01", 'YYYY-MM-DD').toDate(),
      end: moment("2022/02/01", 'YYYY-MM-DD').toDate(),
    },
    { cod: 5,
